package com.udemy.learningprogramming.operators.promotion;
...
//	        double result = x + y;
		...
		// What's the data type of x + y? Compilation error!
//		double x = 44.25;
//		float y = 3.55; Float needs the literal f in the end.
